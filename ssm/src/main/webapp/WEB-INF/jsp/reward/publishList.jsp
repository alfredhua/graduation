		...
		<div class="bs-example4" data-example-id="contextual-table">
			<div style="height: 40px">
				<div style="float: left; height: 40px">
					<form action="money/getPublish.do" method="post" id="query"
						name="query">
				...
				<div class="but_list">
					<div class="bs-example bs-example-tabs" role="tabpanel"
						...
						<ul id="myTab" class="nav nav-tabs" role="tablist">
							<li><a href="money/getRewardList.do?ptype=1&userid=${prizeAndpublishBean.userid}">奖励</a></li>
							<li role="presentation" class="active"><a href="money/getPublish.do?ptype=0&userid=${prizeAndpublishBean.userid}" role="tab"
								id="profile-tab" data-toggle="tab" aria-controls="profile">惩罚</a></li>
						</ul>

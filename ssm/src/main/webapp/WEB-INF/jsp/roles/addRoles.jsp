				...
				<form action="" method="POST">
					...
					<div>				
					    ...
					    <span style="color:red;">*</span>角色名称：</label>
					     <input id="roleName" name="roleName" type="text" class="roleName validate[required]" data-errormessage-value-missing="* 请输入角色名称" maxlength="25"  />
					</div><br/>
					<div>
																	       		
					    <label class="control-label" style="margin-left: -400px">
					    <span style="color:red;">*</span>备&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;注：</label>
					     <input id="remark" name="remark" type="text" class="remark validate[required,maxSize[50]]" data-errormessage-value-missing="* 请输入备注"  />
					</div><br/>
					<div>					 
					   ...
					   <div style="margin-top: 10px;">
						<label class="control-label"  >
					 		...
					 		<c:if test="${empty menu.childrenMenu}">
					   		<input type="checkbox"  value="${menu.id}" name="url"  <c:if test="${menu.id eq '1'}">checked disabled="disabled"</c:if> />	模块	<br>
					 	  	</c:if>	
						   	<c:if test="${!empty menu.childrenMenu}">		 
